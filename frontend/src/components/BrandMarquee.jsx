...
const travelPerks = [
  { name: "50,000+ Global Hotspots", category: "Worldwide Coverage", icon: Globe, color: "text-violet-400" },
  { name: "Curated Boutique Stays", category: "Handpicked Stays", icon: Hotel, color: "text-cyan-400" },
  { name: "Michelin & Local Street Food", category: "Gastronomy Guide", icon: Utensils, color: "text-amber-400" },
  { name: "Paced Day-by-Day Routes", category: "Zero Travel Fatigue", icon: Compass, color: "text-emerald-400" },
  { name: "Interactive Visual Maps", category: "Turn-by-Turn Ready", icon: MapPin, color: "text-fuchsia-400" },
  { name: "Smart Budget Allocation", category: "Transparent Pricing", icon: Wallet, color: "text-blue-400" },
  { name: "Essential Packing Lists", category: "Weather-Ready Gear", icon: CheckCircle2, color: "text-indigo-400" },
  { name: "Bespoke Travel Vibes", category: "Tailored to You", icon: Sparkles, color: "text-rose-400" },
];
