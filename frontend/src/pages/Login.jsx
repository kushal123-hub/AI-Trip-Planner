...
const Login = () => {
  ...
  return (
    <div className="min-h-screen pt-28 pb-16 px-4 flex items-center justify-center relative overflow-hidden">
      {/* Background Ambience */}
      <div className="pointer-events-none absolute top-1/4 -left-32 w-80 h-80 bg-[#08D9D6]/15 rounded-full blur-[120px] -z-10" />
      <div className="pointer-events-none absolute bottom-1/4 -right-32 w-80 h-80 bg-[#FF2E63]/15 rounded-full blur-[120px] -z-10" />
      ...
      <div className="relative w-full max-w-md rounded-3xl border border-white/15 bg-[#252A34]/90 p-8 shadow-2xl backdrop-blur-2xl">
        ...
        <div className="mt-6 text-center text-xs text-slate-400">
          ...
          <Link to="/register" className="font-semibold text-[#08D9D6] hover:underline">
            Sign Up Free
          </Link>
        </div>
