...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen pt-28 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      {/* Welcome Banner */}
      <div className="relative rounded-3xl border border-white/10 bg-gradient-to-r from-[#252A34] via-[#1f232c] to-[#181b22] p-6 sm:p-10 shadow-2xl backdrop-blur-2xl overflow-hidden mb-8">
        <div className="pointer-events-none absolute -top-20 -right-20 h-64 w-64 rounded-full bg-[#08D9D6]/15 blur-3xl" />
        <div className="pointer-events-none absolute -bottom-20 -left-20 h-64 w-64 rounded-full bg-[#FF2E63]/15 blur-3xl" />

        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#08D9D6]/10 border border-[#08D9D6]/20 text-[#08D9D6] text-xs font-semibold mb-3">
              <Sparkles className="h-3.5 w-3.5" />
              <span>Explorer Command Center</span>
            </div>
            <h1 className="text-2xl sm:text-4xl font-extrabold text-white tracking-tight">
              Welcome back, <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#08D9D6] to-[#FF2E63]">{user?.username || "Explorer"}</span>!
            </h1>
          ...
          <div className="flex items-center gap-3">
            <Link
              to="/create-trip"
              className="px-5 py-3 rounded-2xl bg-gradient-to-r from-[#FF2E63] to-[#ff5782] text-white font-semibold text-xs shadow-lg shadow-[#FF2E63]/30 flex items-center gap-2 transition hover:scale-105"
            >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10">
        ...
        {/* Stat 1 */}
        <div className="rounded-3xl border border-white/10 bg-[#252A34]/70 p-6 backdrop-blur-xl shadow-lg flex items-center gap-4">
          <div className="h-14 w-14 rounded-2xl bg-[#08D9D6]/15 border border-[#08D9D6]/30 flex items-center justify-center text-[#08D9D6]">
        ...
        {/* Stat 2 */}
        <div className="rounded-3xl border border-white/10 bg-[#252A34]/70 p-6 backdrop-blur-xl shadow-lg flex items-center gap-4">
          <div className="h-14 w-14 rounded-2xl bg-emerald-500/15 border border-emerald-500/30 flex items-center justify-center text-emerald-400">
            <Wallet className="h-7 w-7" />
          </div>
          <div>
            <p className="text-xs font-medium text-slate-400">Total Planned Budget</p>
            <h3 className="text-2xl sm:text-3xl font-extrabold text-[#08D9D6] mt-0.5">
        ...
        {/* Stat 3 */}
        <div className="rounded-3xl border border-white/10 bg-[#252A34]/70 p-6 backdrop-blur-xl shadow-lg flex items-center gap-4">
          <div className="h-14 w-14 rounded-2xl bg-[#FF2E63]/15 border border-[#FF2E63]/30 flex items-center justify-center text-[#FF2E63]">
            <Clock className="h-7 w-7" />
          </div>
          <div>
            <p className="text-xs font-medium text-slate-400">Upcoming Departures</p>
            <h3 className="text-2xl sm:text-3xl font-extrabold text-[#FF2E63] mt-0.5">{upcomingTrips}</h3>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="rounded-3xl border border-white/10 bg-[#252A34]/70 p-6 backdrop-blur-xl space-y-4">
            ...
            <div className="space-y-2.5">
              <Link
                to="/create-trip"
                className="flex items-center justify-between p-3.5 rounded-2xl border border-[#08D9D6]/30 bg-[#08D9D6]/10 hover:bg-[#08D9D6]/20 text-white text-xs font-semibold transition group"
              >
                <div className="flex items-center gap-2.5">
                  <PlusCircle className="h-4 w-4 text-[#08D9D6]" />
                  <span>Generate New Itinerary</span>
                </div>
                <span className="text-[#08D9D6] group-hover:translate-x-1 transition-transform">→</span>
              </Link>
          ...
          <div className="rounded-3xl border border-[#08D9D6]/20 bg-[#08D9D6]/5 p-6 backdrop-blur-xl">
            <div className="flex items-center gap-2 text-[#08D9D6] text-xs font-bold uppercase tracking-wider mb-2">
              <TrendingUp className="h-4 w-4 text-[#08D9D6]" />
        ...
        <div className="lg:col-span-8 space-y-6">
          <div className="flex items-center justify-between">
            ...
            {totalTrips > 4 && (
              <Link to="/trip-history" className="text-xs font-semibold text-[#08D9D6] hover:underline">
                View all ({totalTrips})
              </Link>
            )}
          </div>
          ...
          {recentTrips.length === 0 ? (
            <div className="rounded-3xl border border-dashed border-white/15 bg-[#252A34]/40 p-12 text-center">
              ...
              <Link
                to="/create-trip"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#FF2E63] hover:bg-[#ff4777] text-xs font-semibold text-white shadow-md shadow-[#FF2E63]/30"
              >
                <PlusCircle className="h-4 w-4" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {recentTrips.map((trip) => (
                <div
                  key={trip.id}
                  className="rounded-3xl border border-white/10 bg-[#252A34]/70 p-5 backdrop-blur-xl flex flex-col justify-between hover:border-[#08D9D6]/40 transition-all group shadow-md"
                >
                  <div className="space-y-3">
                    <div className="flex items-start justify-between">
                      <div className="flex-1 min-w-0 pr-2">
                        <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-[#08D9D6]/10 border border-[#08D9D6]/20 text-[#08D9D6]">
                      ...
                      {trip.ai_itinerary ? (
                        <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-[#08D9D6]/10 border border-[#08D9D6]/20 text-[#08D9D6] shrink-0">
                          AI Active
                        </span>
                      ) : (
                    ...
                    <div className="space-y-1 text-xs text-slate-400">
                      ...
                      <p className="flex items-center gap-1.5 font-semibold text-[#08D9D6]">
                  ...
                  <div className="mt-4 pt-3 border-t border-white/5 flex items-center justify-between">
                    <Link
                      ...
                      className="px-3.5 py-1.5 rounded-xl bg-[#08D9D6]/10 hover:bg-[#08D9D6] text-[#08D9D6] hover:text-[#252A34] text-xs font-semibold flex items-center gap-1.5 transition"
                    >
                    ...
                    <button
                      ...
                      className="p-1.5 rounded-xl text-slate-500 hover:text-[#FF2E63] hover:bg-[#FF2E63]/10 transition cursor-pointer"
                      title="Delete Trip"
                    >
          ...
          <div className="relative w-full max-w-sm rounded-3xl border border-white/15 bg-[#252A34] p-6 text-center shadow-2xl backdrop-blur-2xl">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="flex-1 py-2.5 rounded-xl bg-[#FF2E63] hover:bg-[#ff4777] text-xs font-semibold text-white shadow-md shadow-[#FF2E63]/30 cursor-pointer"
              >
                Delete
              </button>
            </div>
